    ...
    return (
        <Link href={path}>
            <div
                ...
                className={`h-1/5 w-full flex flex-col justify-center items-center  ${isSelected ? 'bg-zinc-900 border-l-[5px] border-spotify' : 'border-black'} hover:bg-zinc-900 border-l-[5px] hover:border-spotify cursor-pointer transition ease-in-out`}>
